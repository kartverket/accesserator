...
require (
	...
	github.com/google/go-containerregistry/pkg/authn/k8schain v0.0.0-20260805202503-7b32099eb119 // indirect
	github.com/google/go-containerregistry/pkg/authn/kubernetes v0.0.0-20260805202503-7b32099eb119 // indirect
